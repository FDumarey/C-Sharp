...
namespace Database {
    ...
    public partial class booksDataSet : global::System.Data.DataSet {
        ...
        public partial class TitlesDataTable : global::System.Data.TypedTableBase<TitlesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TitlesRow AddTitlesRow(string Title, string ISBN) {
...
namespace Database.booksDataSetTableAdapters {
    ...
    public partial class TitlesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Titles` WHERE (((? = 1 AND `Title` IS NULL) OR (`Title` = ?)) AND (`" +
                "ISBN` = ?))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Titles` SET `Title` = ?, `ISBN` = ? WHERE (((? = 1 AND `Title` IS NULL) O" +
                "R (`Title` = ?)) AND (`ISBN` = ?))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Title, ISBN FROM Titles";
        ...
        public virtual int Delete(string Original_Title, string Original_ISBN) {
        ...
        public virtual int Update(string Title, string ISBN, string Original_Title, string Original_ISBN) {
            if ((Title == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Original_Title, string Original_ISBN) {
            return this.Update(Title, Original_ISBN, Original_Title, Original_ISBN);
        }
    }
